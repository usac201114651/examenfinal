...
#CATC  recepcion de audio      
    ...
    #USEOB menú de encriptar
    def ecrip(self):  
        #os.system('clear') 
        print ('Desea encriptar EL mensaje:')
        print ('\t1 - Si')
        print ('\t2 - No')
    ...
    def sendTextUserr(self,num): #MTEZ método para enviar texto a usuario
        #os.system('clear'
        ...
        self.client.publish(('usuarios/16/' +str(UX)), a_enviar) #MTEZ se publca en el topic respectivo, la variable a_enviar
        print('...enviado') 
    ...
    def sendTextRoomm(self,num): #MTEZ METODO PARA EL ENVIO DE TEXTO A SALA
        #os.system('clear')
        self.num=num  
                   
        a_enviar = input ('Escribe mensaje ->') #MTEZ SE RECIBE EL TEXTO A ENVIAR
        a_enviar = self.USER_ID_1 + ' dice: ' + a_enviar #MTEZ se concatena el mensaje a enviar
        self.client.publish(("salas/16/16S0"+ str(num)),  a_enviar ) #MTEZ se publca en el topic respectivo, la variable a_enviar
        print('...enviado') 
        self.client.loop()
    ...
    def sendAudioUser(self,num): #USEOB METODO PARA EL ENVIO DE AUDIO ........
       ...
       # print(size) 
        ...
        self.enviar_audioUU(num) #USEOB SE LLAMA AL METODO ENVIAR AUDIO
    ...
    def sendAudioRoom(self,num): #USEOB METODO PARA EL ENVÍO DE AUDIO A SALAS
        ...
        print(size)
        a_enviar = b'\x03' + bytes("201700512", 'utf-8') + bytes(str(size), 'utf-8') #USEOB SE CONCATENA EL MENSAJE A ENVIAR
        self.client.publish(("audio/16/16S0"+ str(num)),a_enviar ) #USEOB SE CONCATENA EL MENSAJE A ENVIAR
        self.enviar_audioRR(num) #USEOB SE LLAMA AL METODO ENVIAR AUDIO
        logging.info('...enviado') 
    ...
    def enviar_audioUU(self,num): #MTEZ METODO PARA EL ENVIO DE AUDIO
            ...
            self.client.publish(('usuario/16/'+str(UX)), byteArray) #MTEZ SE PUBLICA EN EL USUARIO

    def enviar_audioRR(self,num): #MTEZ METODO PARA EL ENVIO DE AUDIO A SALAS, EL MANEJO DE ARCHIVOS ES IGUAL
            self.num=num  
            filename = 'output.wav'
            f = open(filename, "rb")
            imagestring = f.read()
            ...
            self.client.publish(("audio/16/16S0"+ str(num)), byteArray) #SE PUBLICA EN LA SALA INDICADA
